...
public class Department implements Serializable {
   ...
   */
  public Department(String deptCode, HashMap<String, Course> courses,
   ...
   */
  public int getNumberOfMajors() { return -this.numberOfMajors; }
   ...
   */
  public HashMap<String, Course> getCourseSelection() { return this.courses; }

  /**
   * Increases the number of majors in the department by one.
   */
  public void addPersonToMajor() { numberOfMajors++; }

  /**
   * Decreases the number of majors in the department by one if it's greater
   * than zero.
   */
  public void dropPersonFromMajor() { numberOfMajors--; }
  ...
  /**
   * Returns a string representation of the department, including its code and
   * the courses offered.
   *
