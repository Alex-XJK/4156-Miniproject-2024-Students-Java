...
public class RouteUnitTests {
  ...
  public void indexTest() {
    String expected =
        "Welcome, in order to make an API call direct your browser or"
  ...
  public void courseInfoTest() {
    assertEquals("501 NWC is where the course is located.",
  ...
  public void depatmentInfoTest() {
    ...
    assertEquals("Luca Carloni is the department chair.",
  ...
  public void manipulateCourseTest() {
    ...
    assertEquals(HttpStatus.OK,
                 controller.changeCourseTime("COMS", 3157, "0:00-01:00")
                     .getStatusCode());
    assertEquals(HttpStatus.NOT_FOUND,
                 controller.changeCourseTime("COMS", 9999, "0:00-01:00")
                     .getStatusCode());
    assertEquals(HttpStatus.OK,
                 controller.changeCourseTeacher("COMS", 3157, "Alex Xu")
                     .getStatusCode());
    assertEquals(HttpStatus.NOT_FOUND,
                 controller.changeCourseTeacher("COMS", 9999, "Alex Xu")
                     .getStatusCode());
    assertEquals(HttpStatus.OK,
                 controller.changeCourseLocation("COMS", 3157, "My House")
                     .getStatusCode());
    assertEquals(HttpStatus.NOT_FOUND,
                 controller.changeCourseLocation("COMS", 9999, "My House")
                     .getStatusCode());
  }
